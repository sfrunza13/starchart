...
let SAML_IDP_METADATA_URL =
  'https://login.microsoftonline.com/eb34f74a-58e7-4a8b-9e59-433e4c412757/federationmetadata/2007-06/federationmetadata.xml?appid=9b6e9159-c5ab-462b-8efa-3ecb46e8b6df';
...
const sp = samlify.ServiceProvider({
  entityID: 'https://mycustomdomain-dev.senecacollege.ca/sp',
  nameIDFormat: ['urn:oasis:names:tc:SAML:2.0:nameid-format:persistent'],
  wantAssertionsSigned: true,
  assertionConsumerService: [
    {
      Binding: 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',
      Location: 'https://mycustomdomain-dev.senecacollege.ca/login/callback',
    },
  ],
  singleLogoutService: [
    {
      Binding: 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',
      Location: 'https://mycustomdomain-dev.senecacollege.ca/logout/callback',
    },
  ],
});
